...
namespace CalculoNomina
{
    public partial class Form1 : Form
    {
        ...
        {
            //valida que se introduzca un dato
            if (txtNombre.Text == "")
            {
            ...
            //validar que solo se pueda ingresar datos numericos
        ...
        {
            txtTotalDevengado.Text = myNomina.CalculoNomina(Convert.ToInt32(myNomina.DiasLaborados), 
